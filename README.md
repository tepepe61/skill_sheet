...
また、幼馴染3人や尊敬するエンジニアの先輩と起業なり仕事を通してワクワクするような仕事を行いたいので、なんでもできるフルスタックエンジニアになる必要がある。

#### 計画
現在26歳なので、30歳までに一通りの技術や経験を積みたいと考えています。  
なので、スカウトを頂いた会社様では開発業務をメインに行いたいと思っております。  
Railsなどのバックエンドが一番得意なので、決済追加開発のような重めの開発タスクなどなんでも挑戦したいです。Reactも実務経験済みなのでReactなどを使った開発も行いたいです。  
