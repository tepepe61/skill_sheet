...
### 期間内訳: 2019年4月 ~ 2019年8月
#### プロジェクト: 既存通知機能の機能削除と機能開発
#### 概要: 通知機能で不要なお気に入り機能の削除と「対応/未対応」確認機能の実装
#### 使用技術: Ruby, Ruby on Rails, JavaScript, CoffeeScript,PostgreSQL, CSS, HTML
#### 業務内容兼課題
